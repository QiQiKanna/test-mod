...
public class CornCropBlock extends CropBlock
{
    ...
    {
        BlockState blow = world.getBlockState(pos.down());
        return super.canPlaceAt(state, world, pos) || (blow.isOf(this) && blow.get(AGE) == FIRST_STAGE_AGE);
    }
    ...
    public void randomTick(BlockState state, ServerWorld world, BlockPos pos, Random random)
    {
        ...
        if(world.getLightLevel(pos) >= 9 && random.nextInt((int) (25.0F / f) + 1) == 0 && age < this.getMaxAge())
        {
