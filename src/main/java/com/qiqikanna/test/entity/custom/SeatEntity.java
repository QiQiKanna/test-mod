...
public class SeatEntity extends Entity
{
    ...
    {
        super(ModEntityTypes.SEATS,world);
    ...
    public Vec3d updatePassengerForDismount(LivingEntity passenger)
    {
        ...
        {
            Vec3d vec3d = Dismounting.findRespawnPos(
                    passenger.getType(),
                    this.getWorld(),
                    this.getBlockPos().offset(offset),
                    false);
            if (vec3d != null)
            {
    ...
    private void clampYaw(Entity passenger)
    {
        ...
        float wrappendYaw = MathHelper.wrapDegrees(passenger.getYaw() - this.getYaw());
        float clampYaw = MathHelper.clamp(wrappendYaw,-120.0F,120.0F);
        passenger.prevYaw += clampYaw - wrappendYaw;
        passenger.setYaw(passenger.getYaw() + clampYaw - wrappendYaw);
